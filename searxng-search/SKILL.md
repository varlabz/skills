...
Run [scripts/search.py](scripts/search.py):

```bash
scripts/search.py -q "your query" [options]
```
...
```bash
scripts/search.py -q "AI breakthroughs" -e news -t month
scripts/search.py -q "Python best practices" -f json -n 15
```
